...
export const openrouterModels: ModelConfig[] = [
  ...
  },
  {
    ...
    tags: ["flagship", "reasoning", "performance", "reliability", "fast"],
    contextWindow: 1048576,
    inputCost: 0.15,
    outputCost: 0.6,
    priceUnit: "per 1M tokens",
    ...
    modelPage: 'https://www.meta.com/llama',
    releasedAt: '2025-04-01',
    icon: 'meta',
    apiSdk: (apiKey?: string, opts?: { enableSearch?: boolean }) =>
      createOpenRouter({
  ...
  },
  {
    ...
    baseProviderId: "meta",
    description:
      "Meta's fastest model with enhanced performance.",
    tags: ["fast", "performance", "reliability", "multimodal"],
    contextWindow: 1048576,
    inputCost: 0.08,
    outputCost: 0.30,
    priceUnit: "per 1M tokens",
